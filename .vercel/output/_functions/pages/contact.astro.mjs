...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contact", "description": "Get in touch with us" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="hero"> <div class="hero-content flex-col text-center"> <div class="max-w-md"> <h2 class="text-5xl font-bold">Get in Touch</h2> <p class="py-6">
...
}, "C:/Users/pc02/projects/apologify.com/src/pages/contact.astro", void 0);

const $$file = "C:/Users/pc02/projects/apologify.com/src/pages/contact.astro";
const $$url = "/contact";
